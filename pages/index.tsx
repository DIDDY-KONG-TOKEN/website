  ...
  return (
    <Layout home>
          ...
          <div className="Section-Content">
            <div className="Flexbox">
              <div className="Flexbox-Left">
                <h1>
                  <img
                    src="images/diddyKong-hero-words.png"
                    alt="DiddyKong's Time is here"
                  />
                  <img
                    src="images/diddyKong-hero-words-mobile.png"
                    alt="Rule the Crypto Kingdom"
                  />
                </h1>
                <p>
                  Jump into the fun-filled world of $DIDDYKONG and awaken the
                  playful and adventurous spirit of Diddy Kong.
                </p>
                ...
                <p>Automatically to your wallet.</p>
                <div className="DiddyKong-Socials">
                  ...
                  <a
                    href="https://poocoin.app/tokens/0x81fbE87a976d6c572183Cfaf24f8Acce954A2c30"
                    target="_blank">
                    <img
                  ...
                  <a href="mailto:marekting@diddykong.live">
                    <img
                  ...
                  <a
                    href="https://bscscan.com/token/0x81fbE87a976d6c572183Cfaf24f8Acce954A2c30"
                    target="_blank">
                    <img
      ...
      <section
        ...
        style={{
          backgroundImage: 'url("images/diddyKong-bg-blue.png")',
        }}>
        <div
          className="Section-Border"
          style={{
        ...
        <div className="App-Container">
          <div className="Section-Content">
            ...
            <div className="DiddyKong-Stats DiddyKong-Stats-Desktop">
              <div className="DiddyKong-Stats-Row">
            ...
            <div className="DiddyKong-Stats DiddyKong-Stats-Mobile">
              <div className="DiddyKong-Stats-Row">
                <div className="DiddyKong-Stat">
                  <span>2%</span>
                  <span>
