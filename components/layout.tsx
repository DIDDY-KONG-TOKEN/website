  ...
  return (
    <div className="App">
      <Head>
        ...
        <meta
          name="description"
          content="Jump into the fun-filled world of $DIDDYKONG and awaken the playful and adventurous spirit of Diddy Kong."
        />
        <meta
          property="og:image"
              ...
              <nav className="Header-Nav">
                <ul>
                  ...
                  <li>
                    <a
                      target="_blank"
                      href="https://swap.diddykong.live/">
                      Swap
                    </a>
                  </li>
                  <li>
                    <a
                      target="_blank"
                      href="https://pinball.diddykong.live">
                      Game
                    </a>
                  </li>
                  <li>
